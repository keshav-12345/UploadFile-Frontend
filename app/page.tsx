  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      <div className="flex justify-between items-center">
        <div className="font-bold text-3xl p-10 text-[red]">
          UploadFile
        </div>
        <Link
          href={"/login"}
          onClick={handleLogout}
          className="text-2xl p-5 text-black -mt-4"
        >
          <LogoutOutlined className="text-[red]" />
        </Link>
      </div>
      <div className="flex items-center justify-center flex-col gap-10 text-black pt-20">
        <div className="grid w-full max-w-sm items-center gap-1.5">
          ...
          <Button onClick={handleUpload} className="bg-[red]">
            Upload File
          </Button>
        </div>
        {shortUrl && (
          <div className="flex gap-5 items-center justify-between">
            ...
            <Link href={`${shortUrl}`}>
              <Button className="bg-[red] ">Preview</Button>
            </Link>
          </div>
        )}
